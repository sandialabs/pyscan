...
class Agilent33500(InstrumentDriver):
    ...
    def legacy_sweep_mode(self, values, srate):
        """runs a sweep of voltages at a given sample rate
    ...
    def arb_set(self, name):
        ...
        ----------
        name : str
            Absolute name, relative name or partial name of the arb file
    ...
    def arb_generate(self, waveform, amplitude=0.1, offset=0, srate=1e3, filter="OFF"):
        ...
        amplitude : float
            ...
            does not utilize the entire -1 to +1 range)
        offset : float
             dc voltage offset of waveform
        srate : float
            sample rate in Hz
