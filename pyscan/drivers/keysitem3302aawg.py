...
class KeysiteM3302AAWG(ItemAttribute):
	...
	def set_channel_awg_from_array(self,
		channel, trigger_mode, start_delay, cycles, prescalar, waveform_type,
		...
		self.module.AWGfromArray(channel, trigger_mode, start_delay, cycles,
