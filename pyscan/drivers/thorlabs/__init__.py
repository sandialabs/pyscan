...
try:
    ...
    from .thorlabsct1p import ThorlabsCT1P
    from .thorlabskim101 import ThorlabsKIM101
    ...
    from .thorlabs_exceptions import ThorlabsKinesisImportException as ThorlabsCT1P
    from .thorlabs_exceptions import ThorlabsKinesisImportException as ThorlabsKIM101
