...
class PulseBlaster(ItemAttribute):
    ...
    def init_pb(self):
        ...
        self.spinapi.pb_write_register.argtype = (ctypes.c_int, ctypes.c_int)
        self.spinapi.pb_write_register.restype = (ctypes.c_int)
        ...
        self.spinapi.pb_inst_pbonly.argtype = (
            ctypes.c_int,     # flags
            ctypes.c_int,     # inst
    ...
    def set_defaults(self):
        ...
        """
        return self.spinapi.pb_set_defaults()

    def core_clock(self, clock):
        return self.spinapi.pb_core_clock(ctypes.c_double(clock))

    def write_register(self, address, value):
        return self.spinapi.pb_write_register(address, value)

    def start_programming(self):
        return self.spinapi.pb_start_programming(0)
    ...
    def inst(self, *args):
        ...
        args = tuple(t)
        return self.spinapi.pb_inst_pbonly(*args)
