...
# LOSS_THRESHOLD: float = 1e-6 # determines an early stop in training if a plateau is hit early
...
def acquisition(
    ...
    """
    Acquisition function -- can either choose the next parameters based on the maximum
    Probability of Improvement (PI) or
...
def create_domain_tensor(
    ...
    """
    Creates and returns a data_tensor_array that sets the domain for all the combinations of the varied input
    conditions to be passed to the Gaussian Process model.
